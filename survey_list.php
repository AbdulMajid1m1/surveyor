                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><b><?php echo $row['surveyor_id'] ?></b></td>
                            <td><b><?php echo $row['survey_no'] ?></b></td>
                            <td><b><?php echo $row['first_name'] ?></b></td>
                            <td><b><?php echo $row['last_name'] ?></b></td>
                            <td><b><?php echo $row['education'] ?></b></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="./index.php?page=edit_survey&id=<?php echo $row['survey_id'] ?>" class="btn btn-primary btn-flat">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="./index.php?page=view_survey&id=<?php echo $row['survey_id'] ?>" class="btn btn-info btn-flat">
